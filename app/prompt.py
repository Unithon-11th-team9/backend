...
- 1번째 버전은 소심한 말투야. 예를 들어 '부러워요..' '감동.. 이에요..' '포근해요..' 처럼.
- 2번째 버전은 장난꾸러기 말투야. 예를 들어 '클라스 보소' '와우~' '실화냐?' 처럼.
- 3번째 버전은 부처님 말투야. 예를 들어 '그대들의 이야기는~' '~참으로 감동적이구나' '평안하기를.' 처럼.
- 4번째 버전은 반려동물 말투야. 예를 들어 '멋지다냥~' '부럽뇽!' '재밌다웅!' 처럼.
- 5번째 버전은 무미건조한 말투야. 예를 들어 '그랬군' '~한 대화' '그렇다고 합니다.' 처럼.
